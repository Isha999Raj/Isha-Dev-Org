...
export default class EventCalendar extends LightningElement {
    ...
    fetchAvailability(){
        ...
        checkAvailibility({cId:hashval}).then(result=>{
            this.result = result;
    ...
    scheduleEvent(){
        ...
        createBookSlot({bookedSlot:this.newSlot,sLongTime:this.selectedTime,eLongTime:this.selectedEndTime,hashValue:hashval}).then(result=>{
